...
public class TakePhotoIntentTesting {
    ...
    public void doNotRecordActualCodeTest() { // US 08.01.01
        ...
        DocumentReference creatureRef =  db.collection("Creatures").document(new Creature(MOCK_CODE, null, null, null, null).getHash());
    ...
    public void tearDown() {
        ...
        db.collection("Creatures").document(new Creature(MOCK_CODE, null,null,null,null).getHash()).delete();
        solo.finishOpenedActivities();
    }
